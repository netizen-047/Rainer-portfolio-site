...
### 个人对项目的梳理情况-2026.01.30

网页侧边滚动条效果在：<src\styles\global.scss>
项目页面的项目卡片动画效果在：<src\components\ProjectList.astro>
现有示例项目的文字内容在：<src\pages\detail> 下级目录
首页作品集项目里显示的文字内容与相关标签在：<src\data\home.json>  备注："category"与首頁标签筛选“ dataGroup”标签筛选功能相互关联，这两个类别里的内容要一致，否则首页作品筛选功能无法生效
筛选器作用文件在：<src\components\Filter.astro>
首页/项目/关于的自我介绍部分，首页筛选标签修改在：<src\data\content.ts>
项目页面的作品标签与时间和标题修改在：<src\data\project.ts>
首页的作品集封面文件在：<public\assets\cover>

项目的详情页内容在：<src\pages\detail\todo.astro>
首页的鼠标移动会有3D小图标飘动的图标文件在：<public\assets\effects>
作品的具体图片内容储存在：<src\assets\projects>
“关于我”页面的文字内容修改在：<src\pages\about.astro>
